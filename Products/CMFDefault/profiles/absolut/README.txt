...
requires browsers to support CSS 2.1. HTML5 is used for semantic
clarity and reliable rendering (it enforces "strict").
A Javascript shim enables HTML5 tags for IE <= 8.
